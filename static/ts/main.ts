...
const helperToggleClassName = (element: Element, className: string) => {
    element.classList.toggle(className);
}

const getBackOfNavigation = () => {
    const button = document.querySelector('.hamburger')! as HTMLDivElement;
...
const removeItemWithForm = () => {
    ...
    const submitFormHandler = (btn: Element) => {
